...
<%-- 최신순/오래된순/조회순 선택 --%>
<div style=" float:right; margin-right:200px; font-weight: 1000;">
...
<div style="margin-top: 5px; text-align: center;">			
	<button type ="submit" style="width:10%; margin: 0px 0px 0px 700px; display: inline-block;  " onclick="location.href='write.do'" class="btn btn-outline-primary btn-block my-3" >글쓰기</button>	
</div>
<!--목록표시바-->

	<div class="board row justify-content-md-center" style="margin-left:700px">
	    <jsp:include page="/WEB-INF/views/crap/reviewPaging.jsp">
