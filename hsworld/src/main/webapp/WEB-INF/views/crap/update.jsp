...
<%
   ...
   String summary = dto.getCR_CONTENT();
...
%>
   ...
   <div class="title" style="text-align: center; margin-top:40px" >
        <h3 style="font-family: 'Nanum Gothic', sans-serif; font-weight: 1000;">후기 수정</h3><br>
    </div>
      ...
      <tr>
         <th class="table-primary" rowspan="2" style="width:20%; height:10%;"><h5>제목</h5></th>
         <td style="width:50%; text-align: left;" rowspan="2"><h5 style="text-align:left; margin-left: 20px"><input style=" height:5em; width: 100%; border:0; outline:none; float: left" type="text" name="title" value="<%=title %>"/></h5></td>
      ...
      <tr>
         ...
         <td style="width:50%; text-align: left;" rowspan="5" colspan="5"><h5 style="text-align:left; margin-left: 20px"><textarea style="border:0; outline:none; float: left; resize: none; border:none; height:45em; width: 100%" name="summary"><%=summary %></textarea></h5></td>
      </tr>

   </table>
      <div style="margin-top: 35px; text-align: center;">
            
         <button type ="submit" style="width:10%; display: inline-block; " class="btn btn-primary btn-block my-3" >수정완료</button>
         <button type ="button" style="width:10%; display: inline-block; " class="btn btn-primary btn-block my-3" onclick="location.href='list.do'">목록으로</button>
      </div>
      </form>
