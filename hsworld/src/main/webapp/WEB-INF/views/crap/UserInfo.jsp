...
<div class="container">
	<div class="col-6;">
      <div class="login" >
         <form class="form-control"method="post" style="margin:auto; width:400px;">
            <div>
			<%--회원개인아이디title --%>
			...
			<div class="table-responsive" style="height:400px;">
			      <table class="table text-center">
			        ...
			        <tbody>
			          <tr>
			            <th scope="row" class="text-start">아이디</th>
			            <td>
			        	    <div name="user_id" id="userId"><%=userid%>
			            	</div>
			            </td>
			            <td></td>
			         </tr>
			          <tr>
			            <th scope="row" class="text-start">이름</th>
			            <td>
			        	    <div name="name" id="name"><%=name%>
			            	</div>
			            </td>
			            <td></td>
			         </tr>
			          <tr>
			            <th scope="row" class="text-start">이메일</th>
			            <td>
			        	    <div name="mail" id="mail"><%=mail%>
			            	</div>
			            </td>
			            <td></td>
			         </tr>
			          <tr>
			            ...
			            <td>
			        	    <div name="phone" id="phone"><%=phone%>
			            	</div>
			            </td>
			            <td></td>
			         </tr>
			          <tr>
			            <th scope="row" class="text-start">유저타입</th>
			            <td>
           ...
           <div style="margin-top:40px; margin-bottom:40px; margin-left: 560px;">
		        <button type="button" class="btn btn-outline-primary" onclick="location.href='AdminuserUpdate.do?id=<%=userid %>'" style="btn-primary btn-block" >수정하기</button>
		        <button type="button" class="btn btn-outline-primary " onclick="location.href='memList.do'">목록</button>
	 		</div>   
       </div>
	 </div>
</div>
