...
<div class="title" style="text-align: center; margin-top:40px" >
        <h3 style="font-family: 'Nanum Gothic', sans-serif; font-weight: 1000;">공지사항</h3>
    </div>
...
<div class="board row justify-content-center">
  <table class="table table-hover" style="width: 900px;">
    ...
    <tbody>
		...
		%>
    	<tr>
			<th style="text-align: center;"><%=dto.getNT_UID()%></th>			
	...
	<div class="board row justify-content-md-center">
	    <jsp:include page="/WEB-INF/views/crap/noticePaging.jsp">
